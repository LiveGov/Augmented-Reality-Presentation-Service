...
{
//    NSLog(@"count = %d", [self.values count]);
...
//    NSLog(@"text = %@", [self.values objectAtIndex:[indexPath row]]);
...
{
    [self.delegate selectedElementAtIndex:[indexPath row] andTitle:self.theTitle];
    [self.delegate selectedElementAtIndex:[indexPath row] andID:self.theID];
