	var PoiRadar = {
		...
		show: function initFn() {
			...
			AR.radar.background = new AR.ImageResource("ARchitect_Library/assets/radar_bg.png");

			// set the north-indicator image for the radar (not necessary if you don't want to display a north-indicator)
			AR.radar.northIndicator.image = new AR.ImageResource("ARchitect_Library/assets/radar_north.png");
